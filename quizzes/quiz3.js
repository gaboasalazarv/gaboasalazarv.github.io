...
function showScore(){
    resetState();
    questionElement.innerHTML = `¡Felicidades! Has demostrado tener muy buenos conocimientos sobre las Habilidades Sociales, tu puntaje es ${score} de ${questions.length}. ¡Recuerda que siempre podremos ayudarte!`;
